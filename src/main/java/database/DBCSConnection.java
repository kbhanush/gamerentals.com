...
//Database Connection properties
	...
	public DBCSConnection(ServletContext context) throws SQLException{
		...
		_ords.setURL("jdbc:oracle:thin:@//10.196.133.26:1521/PDB1.dbpm10.oraclecloud.internal");
		_ords.setUser(dbUser);
		_ords.setPassword(dbPass);
		
		_conn = DriverManager.getConnection("jdbc:oracle:thin:@//10.196.133.26:1521/PDB1.dbpm10.oraclecloud.internal","webapp","webapp");
